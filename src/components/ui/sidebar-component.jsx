...
function InterfacesLogoSquare() {
  return (
    <div
      className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div
        className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2">
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div
            className="font-['Lexend:SemiBold',_sans-serif] text-[16px] text-neutral-50">
            Interfaces
          </div>
        </div>
      </div>
      ...
      <div
        ...
        <div
          ...
          <div className="flex flex-col justify-center size-full">
            <div
              className="flex flex-col gap-2 items-start justify-center pr-2 py-1 w-full">
              <input
                type="text"
                placeholder="Search..."
                value={searchValue}
...
function IconNavigation({
  ...
  return (
    <aside
      className="bg-black flex flex-col gap-2 items-center p-4 w-16 h-[800px] border-r border-neutral-800 rounded-l-2xl">
      {/* Logo */}
    ...
    <div
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div
              className="font-['Lexend:SemiBold',_sans-serif] text-[18px] text-neutral-50 leading-[27px]">
              {title}
            </div>
          </div>
        </div>
      ...
      {!isCollapsed && (
        <div className="w-full mt-auto pt-2 border-t border-neutral-800">
          <div className="flex items-center gap-2 px-2 py-2">
            <AvatarCircle />
            <div
              className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-50">Text content</div>
            <button
              type="button"
    ...
    <div
      ...
      <div
        ...
        <div
          ...
          style={{ transitionTimingFunction: softSpringEasing }}>
          <div
            className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-50 leading-[20px] truncate">
            {item.label}
          </div>
        </div>
    ...
    <div className="w-full pl-9 pr-1 py-[1px]">
      <div
        ...
        <div className="flex-1 min-w-0">
          <div
            className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-300 leading-[18px] truncate">
            {item.label}
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-col w-full">
      <div
        ...
        <div className="flex items-center h-10 px-4">
          <div
            className="font-['Lexend:Regular',_sans-serif] text-[14px] text-neutral-400">
            {section.title}
          </div>
        </div>
      </div>
...
export function Frame760() {
  return (
    <div
      className="bg-[#1a1a1a] min-h-screen flex items-center justify-center p-4">
      <TwoLevelSidebar />
    </div>
  );
}
