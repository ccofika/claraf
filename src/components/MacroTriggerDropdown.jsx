    ...
    >
        ...
        <div className="py-1">
          ...
          {results.map((macro, index) => (
            ...
            >
              ...
              <span className="text-sm truncate">{macro.title}</span>
            </button>
          ))}
        </div>
      )}
      <div className="px-3 py-1.5 border-t border-gray-100 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-950">
        <p className="text-xs text-gray-500 dark:text-neutral-500">
          <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-neutral-700 rounded text-xs">Enter</kbd> to insert
          <span className="mx-2">|</span>
          <kbd className="px-1 py-0.5 bg-gray-200 dark:bg-neutral-700 rounded text-xs">Esc</kbd> to close
        </p>
      </div>
    </div>
  );
